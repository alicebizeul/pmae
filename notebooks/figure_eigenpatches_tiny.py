...
c=np.load(f'{folder}/train/pc_matrix.npy').T
eigenvalues=np.load(f'{folder}/train/eigenvalues.npy')
ratio=np.load(f'{folder}/train/eigenvalues_ratio.npy')
mean = np.load(f'{folder}/train/mean_reshaped.npy')
std = np.load(f'{folder}/train/std_reshaped.npy')
...
start_component, stop_component, nb_components = find_threshold(ratio,0.90), find_threshold(ratio,1.0), eigenvalues.shape[0]
...
print(c.shape,ratio.shape)
np.save(f"{folder}/train/eigenvalues_ratio_reduced.npy",ratio)
np.save(f"{folder}/train/pc_matrix_reduced.npy",c)
