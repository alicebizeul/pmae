...
# Linear probe
RUN_TAG=""$EXPERIMENT"_pc_"$MASK"_eval_"$EPOCH"_lin"
...
# MLP probe
RUN_TAG=""$EXPERIMENT"_pc_"$MASK"_eval_"$EPOCH"_mlp"
NAME="../$RUN_TAG"
...
# Fine-tuning
RUN_TAG=""$EXPERIMENT"_pc_"$MASK"_eval_"$EPOCH"_fine"
NAME="../$RUN_TAG"
...
# k-Nearest Neighbors
RUN_TAG=""$EXPERIMENT"_pc_"$MASK"_eval_"$EPOCH"_knn"
NAME="../$RUN_TAG"
